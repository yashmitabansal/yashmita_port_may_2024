      ...
      <div>
        <div className="col-10 mx-auto   homeContent  ">
          <div className="col-md-6 pt-5  ">
            ...
            <div className="self-stretch flex flex-row pt-5 box-border">
              <div className="w-[305px] flex flex-row items-start justify-between gap-[20px] max-w-full mq750:flex-wrap">
                <NavLink to="/About" className="btn homeBtn">
                  About Me
                </NavLink>
                <NavLink to="/Contact" className="btn homeBtn">
                  Contact Me
                </NavLink>
              </div>
            </div>
            ...
            <div className="text-start mt-4 ">
              <div className="flex flex-row space-x-3 justify-start mt-5  mb-10 HomePageLink">
                <a
                  href="https://twitter.com/yashmita_bansal"
                  className="text-[#8fc9f9] hover:text-gray-900 dark:hover:text-white"
                >
                  <svg
                    className="w-7 h-7"
                    fill="currentColor"
                ...
                <a
                  ...
                  className="ml-3 text-[#8fc9f9] cursor-pointer hover:text-gray-700"
                >
                  <svg
                    fill="currentColor"
                    stroke="currentColor"
                ...
                <a
                  ...
                  className="ml-3 mt-1 text-[#8fc9f9] cursor-pointer hover:text-gray-700"
                >
                  <svg
