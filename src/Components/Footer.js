    ...
    <div>
      <footer class="rounded-lg shadow  m-4">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div class="sm:flex sm:items-center sm:justify-between FooterDiv">
            <div
            ...
            <div class="flex mt-4 space-x-3 sm:justify-center sm:mt-0 FooterIconDiv">
              <a
                ...
                class="text-gray-500 hover:text-[#8F33F0]  dark:hover:text-white"
              >
                <svg
                  className="w-6 h-6 FooterIcon"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
          ...
          <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400 FooterLastText">
            © 2024{" "}
